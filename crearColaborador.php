  ...
  <div class="container">
    <?php
      ...
      if ( $_SESSION["userType"] == 'prof' ) {
        $qy="SELECT * FROM PROFESOR WHERE IDPROFESOR=".$_SESSION['userID'];
        $stm=$pdo->prepare($qy);
      $stm->execute();
      foreach($stm as $row){
      $cedula=$row['cedulaProf'];
      $nombre=$row['nombresProf'];
      $apellido=$row['apellidosProf'];
      $correo=$row['correoProf'];
      }
      }
      if ( $_SESSION["userType"] == 'est' ) {
        $qy="SELECT * FROM ESTUDIANTE WHERE IDESTUDIANTE=".$_SESSION['userID'];
        $stm=$pdo->prepare($qy);
      $stm->execute();
      foreach($stm as $row){
      $cedula=$row['cedulaEst'];
      $nombre=$row['nombresEst'];
      $apellido=$row['apellidosEst'];
          ...
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="nombre" readonly name="nombre" type="text" maxlength="50" placeholder="Ingrese sus nombres" value="<?php echo $nombre ?>"  required>
              </div>
              <div class="col-md-6">
                <label for="apellido">Apellidos</label>
                <input class="form-control" id="apellido" readonly name="apellido" type="text" placeholder="Ingrese sus Apellidos" value="<?php echo $apellido ?>"  required>
              </div>
            </div>
      ...
      <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" style="border-radius: 5px;" type="date" name="bday" required>
              </div>
              <div class="col-md-6">
      ...
      <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="nombre" name="direccion" type="text" maxlength="50" placeholder="Ingrese la calle de su dirección" required>
              </div>
              <div class="col-md-6">
                <label for="numcalle">Número de calle</label>
                <input class="form-control" id="apellido" name="calle" type="text" placeholder="Ingrese número de calle" required>
              </div>
            </div>
      ...
      <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="nombre" name="transversal" type="text" maxlength="50" placeholder="Ingrese transversal" required>
              </div>
              <div class="col-md-6">
                <label for="numcalle">Sector</label>
                <input class="form-control" id="apellido" name="sector" type="text" placeholder="Ingrese Sector" required>
              </div>
            </div>
      ...
      <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
                ...
                <input class="form-control" id="nombre" name="ciudad" type="text" maxlength="50" placeholder="Ingrese su Ciudad" required>
              </div>
              <div class="col-md-6">
                <label for="tlf">Convencional</label>
                <input class="form-control" id="apellido" name="convencional" type="text" placeholder="Ingrese número de telefono" required>
              </div>
            </div>
